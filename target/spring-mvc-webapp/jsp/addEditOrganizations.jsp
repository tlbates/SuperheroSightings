<%-- 
    Document   : addEditOrganizations
    Created on : Oct 25, 2018, 7:58:56 PM
    Author     : tylerbates
--%>
                    ...
                    <div class="col-md-6">
                        <form class="form-horizontal" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="orgId" value="${orgToEdit.id}" readonly/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name" class="col-md-4 control-label">Name: </label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="name" placeholder="${orgToEdit.name}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="phone" class="col-md-4 control-label">Phone: </label>
                                <div class="col-md-8">
                                    <input type="phone" class="form-control" name="phone" placeholder="${orgToEdit.phone}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="email" class="col-md-4 control-label">Email: </label>
                                <div class="col-md-8">
                                    <input type="email" class="form-control" name="email" placeholder="${orgToEdit.email}"/>
                                </div>
                            </div>
                            <div class="form-group">
